...
module Hotel
  class Hotel
    ...
    def initialize
      ...
      def make_reservation(date1, date2=nil) #name = nil)
      ...
      def make_block(partyname, discounted_rate, number_rooms, date1, date2=nil)
        block_rooms = []
        index = 0
        if number_rooms > 5
        ...
        thisblock = Block.new(partyname, discounted_rate, block_rooms, date1, date2=nil)
        @blocks << thisblock
      end
      # puts @blocks
