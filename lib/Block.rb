...
module Hotel
  class Block
    ...
    attr_reader  :room_num_array, :block_date_range_array, :discount_percent, :reservation_array

    def initialize(room_num_array, check_in, check_out, discount_percent: 0)
