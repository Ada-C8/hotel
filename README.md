...
- _As an administrator, I can reserve a room for a given date range_
- _As an administrator, I can access the list of reservations for a specific date_
- _As an administrator, I can get the total cost for a given reservation_
