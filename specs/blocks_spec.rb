...
describe "block" do
  ...
  it "can initialize a block" do
    block_1 = Hotel::Block.new( Date.new(2019, 11, 15), Date.new(2019, 11, 15), "T Payne", "8675309", 10, 15)
    block_1.must_be_instance_of Hotel::Block
  end

  it "can return the correct information" do

    block_1 = Hotel::Block.new( Date.new(1900, 02, 20), Date.new(1900, 02, 22), "Dr. Frankenstein", "8675309", 15 , 15)
  ...
  describe "nights_reserved method" do
    it "can get dates from block" do
      block_1 = Hotel::Block.new(Date.new(2019, 11, 15), Date.new(2019, 11, 17), "Dr. Frankenstein", "8675309", 20, 15)
  ...
  describe "change_discount" do
    it "can change the discount on a block" do
      block_1 = Hotel::Block.new( Date.new(1900, 02, 20), Date.new(1900, 02, 22), "Dr. Frankenstein", "8675309", 15, 20)
  ...
  describe "price_all_rooms" do
    it "calculates the price for all rooms" do
      block_1 = Hotel::Block.new( Date.new(1976, 02, 20), Date.new(1976, 02, 22), "Norman Bates", "8675309", 15, 20)
