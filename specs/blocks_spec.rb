...
describe "block" do
  ...
  it "can initialize a block" do
    block_1 = Hotel::Block.new( [2019, 11, 15], [2019, 11, 15], 4, "T Payne", "8675309", 10)
    block_1.must_be_instance_of Hotel::Block
  end

  it "can return the correct information" do

    block_1 = Hotel::Block.new( [1900, 02, 20], [1900, 02, 22], 3, "Dr. Frankenstein", "8675309", 15 )
...
describe "nights_reserved method" do
  it "can get dates from block" do
    block_1 = Hotel::Block.new([2019, 11, 15], [2019, 11, 17], 7, "Dr. Frankenstein", "8675309", 20 )
