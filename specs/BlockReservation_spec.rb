...
describe "HotelBooking::BlockReservation class" do
  describe "initialize" do
    it "initalizes" do
      ...
      new_block_res = HotelBooking::BlockReservation.new(check_in_str, check_out_str,room_id,b_res_id,discounted_rate, block_id)
  ...
  describe "num_nights_charged" do
    ...
    it "correctly inherits the num_nights_charged method from the HotelBooking::Reservation class" do
      blockres1 = HotelBooking::BlockReservation.new("2018-02-14", "2018-02-16",3,14,5)
  ...
  describe "cost" do
    it "calculates cost with a discounted rate" do
      discounted_rate = 5
      blockres1 = HotelBooking::BlockReservation.new("2018-02-14", "2018-02-16",14,42,discounted_rate)
      blockres1.cost.must_equal 10

      blockres2 = HotelBooking::BlockReservation.new("2018-12-01", "2018-12-02",1,5,discounted_rate)
