...
describe "Room" do
  ...
  describe "initialize" do
    it "Creates a room instance object with a room number" do
      ...
      another = ReservationSystem::Room.new(100) #TODO 1. decide- Testing edge cases... could check for room parameters. Currently allowing rooms to be 'numbered' however.
      another.number.must_equal 100
    end
